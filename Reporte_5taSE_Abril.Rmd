...
SEMANAtxt="Hasta 4ta. Semana de Abril"
...
table(datamodel$abr_4,datamodel$abr_3,dnn = c("ACTUAL","ANTERIOR")) %>%
...
```{r,echo=FALSE}
mejor=sum(datamodel$abr_4<datamodel$abr_3)
igual=sum(datamodel$abr_4==datamodel$abr_3)
peor=sum(datamodel$abr_4>datamodel$abr_3)
```
