...
SEMANAtxt="Hasta Última Semana de Julio"
...
table(datamodel$jul_4,datamodel$abr_3,dnn = c("ACTUAL","ANTERIOR")) %>%
...
```{r,echo=FALSE}
mejor=sum(datamodel$jul_4<datamodel$jul_3)
igual=sum(datamodel$jul_4==datamodel$jul_3)
peor=sum(datamodel$jul_4>datamodel$jul_3)
```
...
```{r, echo=FALSE}
library(DescTools)
histIndex=grep("feb|mar|abr|may|jun|jul",names(datamodel))
