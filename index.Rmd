...
casos=base+geom_line(aes(x=semana,
                        y=pos,group=1),color='pink') + annotate("rect", xmin = ini2021, xmax = semact, ymin = 0, ymax = 70000,fill='grey70',
  alpha = .1) + annotate("text", x = ini2021+4, y = 70000-2000, label = "2021")
...
falles=base+geom_line(aes(x=semana,
                        y=falles_cov,group=1), color="grey70") + annotate("rect", xmin = ini2021, xmax = semact, ymin = 0, ymax = 2500,fill='grey70',
  alpha = .1)+ annotate("text", x = ini2021+4, y = 2500-100, label = "2021")
...
movil=base+geom_line(aes(x=semana,
                        y=inmo,group=1), color="cyan3") + annotate("rect", xmin = ini2021, xmax = semact, ymin = 0, ymax = 100, fill='grey70',
...
cam=base+geom_line(aes(x=semana,
                        y=cam,group=1), color="chartreuse")+ annotate("rect", xmin = ini2021, xmax = semact, ymin = 0, ymax = 100, fill='grey70',
  alpha = .1)+ annotate("text", x = ini2021+4, y = 95, label = "2021")
...
uci=base+geom_line(aes(x=semana,
                        y=uci,group=1), color="darkgoldenrod2")+ annotate("rect", xmin = ini2021, xmax = semact, ymin = 0, ymax = 100, fill='grey70',
  alpha = .1)+ annotate("text", x = ini2021+4, y = 95, label = "2021")
...
### Comparación (%) - ¿Pico de Inmovilidad antecede a valles?
