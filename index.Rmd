...
inci6=inci6+scale_fill_brewer(drop=FALSE,
                              palette = 'YlOrRd')+guides(fill=FALSE) + labs(title = "Hace 1 semana")
...
### Incidencia de Casos {.no-padding}
```{r}
inci1
```
...
### Incidencia de Casos (No considerada en modelo)
```{r}
inci5
```
...
### Mortalidad (No considerada en modelo)
