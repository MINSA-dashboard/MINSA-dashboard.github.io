...
### Movilidad (% Permanencia en Casa si 0 es permanancia antes de pandemia)
...
### Comparación Casos / Fallecidos / Movilidad
```{r}
...
both2=both2+theme(axis.text.x = element_text(angle = 80,
                                           ...
                                           vjust = 0.5,
                                           hjust = 0.5))
both2=both2 + scale_y_log10()+ geom_vline(xintercept = 47, color='grey',linetype=2)
