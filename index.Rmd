...
line1=line  +  scale_x_continuous(breaks = 1:19,limits = c(1,19)) + scale_y_log10() +geom_vline(xintercept = c(7,9),color=c("grey","black"),linetype=2) + geom_text(x=7,y=1,label="Vacuna\nSalud",angle=90)  + geom_text(x=9,y=1,label="Vacuna\nSeguridad",angle=90)
...
line2=line  + scale_x_continuous(breaks = 15:33,limits = c(15,33)) 
...
line3=line  +  scale_x_continuous(breaks = 1:19,limits = c(1,19))+ scale_y_log10() +geom_vline(xintercept = c(7,9),color=c("grey","black"),linetype=2) + geom_text(x=7,y=1,label="Vacuna\nSalud",angle=90)  + geom_text(x=9,y=1,label="Vacuna\nSeguridad",angle=90)
...
line4=line4 + theme(legend.position = "none") +  scale_x_continuous(breaks = 1:19,limits = c(1,19)) +labs(title=" ",y="Conteo",color=" ")  +geom_vline(xintercept = c(7,9),color=rep(c("grey","black"),3),linetype=2) 
...
line5=line  + scale_x_continuous(breaks = 15:33,limits = c(15,33))
...
line6=line6 + theme(legend.position = "none") +  scale_x_continuous(breaks = 1:19,limits = c(1,19)) +labs(title=" ",y="",color=" ") + scale_y_log10()
...
geodata=allCovid_geo[allCovid_geo$anosem<=202119,]
